...
namespace Aufgabe6a {
    ...
    function init(_event: Event): void {
        ...
        for (let i: number = 0; i < count; i++) {
            ...
            let b: beeSwarm = { x: 558, y: 420, size: size1, color: "#FFB300" };
            bees[i] = b;
        }
    ...
    function newBee(_event: Event): void {
        ...
        let bee: beeSwarm = { x: 558, y: 420, size: size2, color: "#FFB300" };
        bees.push(bee);
        count++;
    }
    ...
    function drawBee(x: number, y: number, _size: boolean, _color: string): void {
        if (_size == true) {
            crc2.beginPath();
